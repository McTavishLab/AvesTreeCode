...
1) dates are estameted acorss 100 iterations of the stochastic taxon addition process
2) For each tree calibrations are applied using the mean date for each node, as well as the
